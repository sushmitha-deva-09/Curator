...
class Classifier(NeuralModule, Exportable):
    ...
    def post_init(self, use_transformer_init: bool) -> None:
        """
    ...
    def input_example(self, max_batch: int = 1, max_dim: int = 256) -> tuple[torch.Tensor, ...]:
        """
    ...
    @classmethod
    def restore_from(cls, restore_path: str) -> None:
        """
